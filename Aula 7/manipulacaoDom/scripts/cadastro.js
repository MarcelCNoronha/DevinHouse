...
function fazerCadastro() {
    ...
    if(nome === "") {
        ...
        document.getElementById('campo-usuario').classList.add('input-error')
        document.getElementById('error-usuario').hidden = false
        document.getElementById('error-usuario').innerText = "O usuário é obrigatório"
    }
